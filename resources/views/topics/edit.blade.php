...
@section('actions')
    <a href="#" class="btn btn-sm btn-outline-primary my-auto"
       ...
       aria-label="Save">{{ trans('canvas::buttons.topics.update') }}</a>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
            <a href="#" class="dropdown-item text-danger" data-toggle="modal" data-target="#modal-delete">{{ trans('canvas::buttons.general.delete') }}</a>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                @include('canvas::components.forms.topic.edit')
                @include('canvas::components.modals.topic.delete')
            </div>
        </div>
    </div>
@endsection
