...
@section('actions')
    <a href="#" class="btn btn-sm btn-outline-primary my-auto"
       ...
       aria-label="Save">{{ __('canvas::buttons.topics.update') }}</a>
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
            <a href="#" class="dropdown-item text-danger" data-toggle="modal" data-target="#modal-delete">{{ __('canvas::buttons.general.delete') }}</a>
        </div>
    </div>
@endsection
