<div class="form-group">
    ...
    <div class="col-md-8">
        <input type="text" class="form-control simplebox" name="title" id="title" value="{{ $title }}">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-8">
        <textarea class="form-control simplebox" id="meta_description" name="meta_description" rows="3">{{ $meta_description }}</textarea>
    </div>
</div>
<div class="form-group">
    <label for="page_image" class="col-md-3 control-label">Page Image</label>
    <div class="col-md-8">
        <input type="text" class="form-control simplebox" name="page_image" id="page_image" value="{{ $page_image }}">
    </div>
</div>
<div class="form-group">
