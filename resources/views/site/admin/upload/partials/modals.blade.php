            ...
            <form method="POST" action="/admin/upload/folder" class="form-horizontal">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="new_folder_name" name="new_folder" class="form-control simplebox">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-outline">
                        <i class="fa fa-fw fa-save"></i> Save New Folder
                    </button>
                </div>
            </form>
        </div>
            ...
            <div class="modal-footer">
                <form method="POST" action="/admin/upload/file">
                    ...
                    <button type="submit" class="btn btn-danger btn-outline">
                        <i class="fa fa-fw fa-times-circle"></i> Delete File
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form method="POST" action="/admin/upload/folder">
                    ...
                    <button type="button" class="btn btn-default btn-outline" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-danger btn-outline">
                        <i class="fa fa-fw fa-times-circle"></i> Delete Folder
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-content">
            <form method="POST" action="/admin/upload/file" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="file_name" class="col-sm-3 control-label">Filename</label>
                        <div class="col-sm-4">
                            <input type="text" id="file_name" name="file_name" class="form-control simplebox" placeholder="Optional">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-primary btn-outline">
                        <i class="fa fa-fw fa-save"></i> Save New File
                    </button>
                </div>
            </form>
        </div>
