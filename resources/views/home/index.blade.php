    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-md-offset-1">
                ...
                <br />
                <center>
                    <a href="blog" class="btn btn-default btn-outline btn-sm"><i class="fa fa-fw fa-edit"></i> Blog</a>
                    <a href="admin" class="btn btn-default btn-outline btn-sm"><i class="fa fa-fw fa-user"></i> Admin</a>
