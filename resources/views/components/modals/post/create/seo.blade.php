                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <input type="text"
                               ...
                               name="og_title" title="{{ trans('canvas::posts.forms.seo.facebook.title.label') }}" value="{{ old('og_title') }}"
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <textarea name="og_description" class="form-control border-0 px-0" rows="1"
                                  ...
                                  title="{{ trans('canvas::posts.forms.seo.facebook.description.label') }}">{{ old('og_description') }}</textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control border-0 px-0"
                               name="twitter_title" title="{{ trans('canvas::posts.forms.seo.twitter.title.label') }}" value="{{ old('twitter_title') }}"
                ...
                <div class="form-group row">
                    <div class="col-12">
                        ...
                        <textarea name="twitter_description" class="form-control border-0 px-0" rows="1"
                                  ...
                                  title="{{ trans('canvas::posts.forms.seo.twitter.description.label') }}">{{ old('twitter_description') }}</textarea>
                    </div>
                </div>
            </div>
