<template>
    <div class="border-bottom">
        <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1 col-md-12">
            <nav class="navbar d-flex justify-content-between px-0 py-1">
...
<!--                <section v-else>-->
<!--                    <router-link :to="{ name: 'tags' }" class="btn btn-link text-decoration-none">-->
<!--                        Tags-->
<!--                    </router-link>-->
<!--                    <router-link :to="{ name: 'topics' }" class="btn btn-link text-decoration-none">-->
<!--                        Topics-->
<!--                    </router-link>-->
<!--                    <a :href="`/${canvasPath}/login`" class="btn btn-link text-decoration-none">Sign in</a>-->
<!--                </section>-->
            </nav>
        </div>
    </div>
