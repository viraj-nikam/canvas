            ...
            <div class="col-xl-10 offset-xl-1 px-xl-5 col-md-12">
                ...
                <div v-if="isReady">
                    <div v-if="posts.all.length">
                        ...
                        <line-chart :views="JSON.parse(views.trend)" class="my-5" />
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-link text-success text-decoration-none font-weight-bold btn-block" @click.prevent="limit += 7" v-if="loadMore">
