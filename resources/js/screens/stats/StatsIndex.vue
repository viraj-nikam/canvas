                            ...
                            <div v-if="posts.all.length">
                                ...
                                <div class="card-deck mb-4">
                                    <div class="card shadow bg-transparent">
                                        <div class="card-body">
                                            <h5
                                                class="card-title text-muted small text-uppercase font-weight-bolder"
                                            >
                                                {{
                                                    trans.stats.cards.views
                                                        .title
                                                }}
                                            </h5>
                                    ...
                                    <div class="card shadow bg-transparent">
                                        <div class="card-body">
                                            <h5
                                                class="card-title text-muted small text-uppercase font-weight-bold"
                                            >
                                                {{
                                                    trans.stats.cards.posts
                                                        .title
                                                }}
                                            </h5>
                                            <p class="card-text display-4">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a
                                            href="#!"
                                            class="btn btn-link text-success text-decoration-none font-weight-bold btn-block"
                                            @click="limit += 7"
                                            v-if="loadMore"
                                        >
