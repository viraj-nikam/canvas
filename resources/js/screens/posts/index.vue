                                ...
                                <div class="dropdown-menu dropdown-menu-right py-0 shadow-sm" id="searchDropdown" aria-labelledby="dropdownMenuButton">
                                    <form class="pl-2 w-100">
                                        <div class="form-group mb-0">
                                            <input v-model="search" type="text" class="form-control border-0 pl-0" id="search" :placeholder="trans.posts.search.input" autofocus/>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div v-if="posts.length" class="mt-2">
                                <div class="d-flex border-top py-3 align-items-center" v-for="post in filteredList">
                                    <div class="mr-auto py-1">
                                        <p class="mb-1">
                                            <router-link :to="{name: 'posts-edit', params: { id: post.id }}" class="font-weight-bold text-lg lead text-decoration-none text-dark">
                                                {{ post.title }}
                                            </router-link>
                                        </p>
                                    ...
                                    <div class="ml-auto d-none d-lg-block">
                                        <router-link :to="{name: 'posts-edit',params: { id: post.id }}">
                                            ...
                                            <div class="mr-3 align-middle" v-else>
