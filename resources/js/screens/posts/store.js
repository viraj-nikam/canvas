...
export const store = {
    ...
    hydrateForm(data) {
        ...
        this.state.form.featured_image_caption = _.get(
            data,
            "featured_image_caption",
            ""
        );
        this.state.form.meta.meta_description = _.get(
            data,
            "meta.meta_description",
            ""
        );
        this.state.form.meta.og_title = _.get(data, "meta.og_title", "");
        this.state.form.meta.og_description = _.get(
            data,
            "meta.og_description",
            ""
        );
        this.state.form.meta.twitter_title = _.get(
            data,
            "meta.twitter_title",
            ""
        );
        this.state.form.meta.twitter_description = _.get(
            data,
            "meta.twitter_description",
            ""
        );
        this.state.form.meta.canonical_link = _.get(
            data,
            "meta.canonical_link",
            ""
        );
