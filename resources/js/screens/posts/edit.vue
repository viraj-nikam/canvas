<template>
    <div v-cloak>
                    ...
                    >
                        ...
                        <ul class="navbar-nav mr-auto flex-row float-right">
                            <li class="text-muted font-weight-bold">
                                ...
                                <span
                                    v-if="storeState.form.isSaving"
                                    class="pl-2"
                                    >{{ trans.nav.notify.saving }}</span
                                >
                                <span
                                    v-if="storeState.form.hasSuccess"
                    ...
                    <div class="col-md-8" v-if="isReady">
                        <div class="form-group row my-3">
                            <div class="col-lg-12">
                                <textarea-autosize
                                    :placeholder="
                                        trans.posts.forms.editor.title
                                    "
        ...
        <publish-modal v-if="isReady" ref="publishModal"> </publish-modal>
        ...
        <seo-modal v-if="isReady" ref="seoModal"> </seo-modal>
