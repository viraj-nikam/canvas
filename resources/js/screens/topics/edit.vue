            ...
            <div class="container d-flex justify-content-center px-0">
                <div class="col-md-10 px-0">
                    <nav class="navbar navbar-light justify-content-between flex-nowrap flex-row py-1">
                        ...
                        <a href="#" @click="saveTopic" class="btn btn-sm btn-outline-primary font-weight-bold my-auto ml-auto" :class="{ disabled: form.name === '' }" :aria-label="trans.buttons.general.save">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="form-group row my-5">
                            <div class="col-lg-12">
                                <input type="text" name="name" autocomplete="off" v-model="form.name" title="Name" @keyup.enter="saveTopic" class="form-control-lg form-control border-0 px-0" :placeholder="trans.topics.forms.placeholder"/>
