            ...
            <div class="container d-flex justify-content-center px-0">
                <div class="col-md-10 px-0">
                    <nav class="navbar navbar-light justify-content-between flex-nowrap flex-row py-1">
                        ...
                        <router-link to="/topics/create" class="btn btn-sm btn-outline-primary my-auto ml-auto mr-3">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10">
                        <div class="d-flex justify-content-between">
                            <h1 class="mb-4 mt-2">{{ trans.topics.header }}</h1>
                        ...
                        <div v-if="isReady">
                            <div v-if="topics.length">
                                ...
                                <p class="mt-4" v-if="!filteredList.length">{{ trans.topics.search.empty }}</p>
                            </div>
                            <div v-else>
